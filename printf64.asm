; COPIED FROM: https://www.csee.umbc.edu/portal/help/nasm/sample_64.shtml
; Provides good examples of using the registers to pass parameters to
; printf.  Their site also has 32-bit equivellent which uses the stack
; to pass the parameters (https://www.csee.umbc.edu/portal/help/nasm/sample.shtml).
; They used nasm to assemble, but it also worked without issue using yasm.
;==================================================================================
;
